...
class UserIntent:
    ...
    use_case: list[str] = field(default_factory=list)      # gaming, chụp ảnh, công việc
    budget: dict = field(default_factory=dict)               # price_min, price_max
    priorities: list[str] = field(default_factory=list)      # pin trâu, màn đẹp, nhẹ
    brand_preference: str | None = None
    category: str | None = None
    target_audience: str | None = None                       # sinh viên, dân văn phòng
